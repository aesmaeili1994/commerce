        ...
        <div class="col-xl-12 col-md-12 mb-4 p-4 bg-white">
            ...
            <div class="row">
                ...
                <div class="form-group col-md-3">
                    ...
                    <input class="form-control" type="text" value="{{ $order->user->name == null ? 'کابر' : $order->user->name }}" disabled>
                </div>
                <div class="form-group col-md-3">
                    <label>کد کوپن</label>
                    <input class="form-control" type="text" value="{{ $order->coupon_id == null ? 'بدون کد تخفیف' : $order->coupon->code }}" disabled>
                </div>
                <div class="form-group col-md-3">
                    <label>وضعیت</label>
                                ...
                                <tr>
                                    <td class="product-thumbnail">
                                        <a href="{{ route('admin.products.show',['product'=>$item->product->id]) }}">
                                            <img width="70" src="{{ asset(env('PRODUCT_IMAGES_UPLOAD_PATH').$item->product->primary_image) }}"
                                    ...
                                    <td class="product-name">
                                        ...
                                        <p class="mb-0" style="font-size: 12px; color: red">
                                            {{ \App\Models\Attribute::find($item->productVariation->attribute_id)->name }}
                                            :

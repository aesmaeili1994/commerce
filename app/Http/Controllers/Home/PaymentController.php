...
class PaymentController extends Controller
{
    public function payment(Request $request)
    {
        ...
        if ($request->payment_method == 'zarinpal') {
            ...
            $zarinpalGatewayResult = $zarinpalGateway->send($amounts,'خرید تست',$request->address_id);
        ...
        alert()->error('درگاه پرداخت انتخابی اشتباه می باشد','دقت کنید');
        return redirect()->back();
    ...
    public function paymentVerify(Request $request,$gatewayName)
    {
        ...
        if ($gatewayName == 'zarinpal') {
            ...
            if (array_key_exists('error',$zarinpalGatewayResult)) {
                ...
                alert()->success($zarinpalGatewayResult['success'],'باتشکر');
                return redirect()->route('home.index');
            }
        }
    ...
    public function getAmounts()
    {
        ...
        return [
            ...
            'paying_amount'=>(cartTotalAmount() + cartTotalDeliveryAmount())
        ];
    }
}
